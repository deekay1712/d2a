	...
	return (
		<div className='homeTestimonialsWrapper'>
			...
			<p className='homeTestimonialsText'>
				Our firm had the distinct pleasure of building one of C-34&#39;s
				signature project. Not only was the architecture and design superior but
				they executed the plans and specifications meticulously. It was easy to
				bring their thoughts and visions into reality due to their commitment to
				thinking all the details through and communicating them both verbally
				and in plan format. The quality of our work was able to be at its
				highest level due to their commitment. As a team member on the project
				we felt included, valued and respected in our relationship with the
