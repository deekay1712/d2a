			...
			<div className='teamFounder'>
				<div className='teamMemberBlock'>
					<div className='teamFounderImageContainer'>
						<img
							...
							src='/Assets/Team/rajesh.jpg'
							alt='Founder'
						/>
					</div>
					<div className='teamMemberNameWrapper'>
						<p className='teamMemberName'>Rajesh Kumar</p>
						<a
							href='https://www.linkedin.com/in/rajeshkr1997/'
							target='_blank'
							rel='noreferrer'
							className='teamFounderSocial'>
							<img
								className='teamMemberLinkedinIcon'
				...
				<div className='teamMemberBio'>
					<p className='teamMemberBioText'>
						Rajesh Kumar has worked at the Skets Studio and HBA International,
						are most experienced companies in outsourcing and designing
						industry. He has enough knowledge and experience to manage the
						projects and deliver in estimated time. Kumar is using his past
						experience to grow the company and to making generations to more
						knowledgeable and skillfull for future.
					</p>
				</div>
			</div>
			<div className='teamFounder'>
				<div className='teamMemberBlock'>
					...
					<div className='teamMemberNameWrapper'>
						...
						<a
							href='https://www.linkedin.com/in/dharmender-jaishwal/'
							target='_blank'
							rel='noreferrer'
							className='teamFounderSocial'>
							<img
				...
				<div className='teamMemberBio'>
					<p className='teamMemberBioText'>
						D.K. Jaishwal experience spans across 4 all aspects of the industry
						including major infrastructure, residential and commercial sectors.
						After the fundamental and practical aspects of each sector were
						established, Jaishwal went on to excel in Project Management, Site
