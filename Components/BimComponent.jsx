...
export default function BimComponent() {
  ...
  return (
    <div className="outsourcingServiceComponentWrapper">
        <div className="outsourcingServiceComponentHeader3">
            <h1 className="outsourcingServiceComponentHeaderTitle">BIM</h1>
        </div>
        <div className="outsourcingServiceComponentContent">
            <p className="outsourcingServiceComponentContentText">Whether you are an architect, engineer, builder, contractor, or owner, D2A Atelier can provide expert services to help you overcome any technological, economic, personnel, or infrastructure issues you may face. The services include Revit design, drawing, and modelling.</p>
            ...
            <div className="outsourcingServiceFilter">
              <span  className={`outsourcingServiceFilterButton ${filter===1? 'outsourcingServiceFilterButtonSelected':``}`} onClick={()=>filterButton(1)}>PDF to BIM</span>
              <span  className={`outsourcingServiceFilterButton ${filter===2? 'outsourcingServiceFilterButtonSelected':``}`} onClick={()=>filterButton(2)}>CAD to BIM</span>
              <span  className={`outsourcingServiceFilterButton ${filter===3? 'outsourcingServiceFilterButtonSelected':``}`} onClick={()=>filterButton(3)}>Revit family creation</span>
              <span className={`outsourcingServiceFilterButton ${filter===4? 'outsourcingServiceFilterButtonSelected':``}`} onClick={()=>filterButton(4)}>Scan to BIM</span>
            </div>
