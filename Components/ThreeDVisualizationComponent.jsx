export default function ThreeDVisualizationComponent(){
    return (
        ...
        <div className="outsourcingServiceComponentHeader4">
            <h1 className="outsourcingServiceComponentHeaderTitle">3D Visualizations</h1>
        </div>
        ...
        <div className="outsourcingServiceComponentImages">
            <img className="outsourcingServiceComponentImage" src="/Assets/OutsourcingServices/3d-visualization-1.jpg" alt="3D Visualization" />
            <img className="outsourcingServiceComponentImage" src="/Assets/OutsourcingServices/3d-visualization-2.jpg" alt="3D Visualization" />
            <img className="outsourcingServiceComponentImage" src="/Assets/OutsourcingServices/3d-visualization-3.jpg" alt="3D Visualization" />
        </div>
    </div>
    )
}