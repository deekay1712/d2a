    ...
    <div className="aboutUsWrapper">
      {
        ...
        <>
          ...
          <div className="aboutUsText">
              ...
              <p className="aboutUsTextContent">D2A Atelier was founded in 2020 by its Founder & CEO D.K. Jaishwal and Co-Founder & Managing Director Rajesh Kumar. The company has enough experience and creative minds to achive the goal and give a path to the next generation. <br/>D2A Atelier has grown its clientele rapidly since 2020 with a high level of satisfaction in their architectural practices through their excellent team management, communication and high quality luxurious designs.</p>
              <h1 className="aboutUsTextHeading">Who we are?</h1>
              <p className="aboutUsTextContent">Excited by the possibility of what could be? So are we. <br />
              In fact, our whole process is about opening up to new ideas and pushing beyond the predictable. Because even though we have done this many times before, we haven't designed your exact project before. Whether it be making gutsy decisions or keeping things simple, every project calls for a different approach. <br />
