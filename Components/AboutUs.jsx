  ...
  return (
    <div className="aboutUsWrapper">
        ...
        <div className="aboutUsText">
            ...
            <p className="aboutUsTextContent">To be viewed as a respected architectural firm, provding high quality design and services to our clients with honesty and integrity.</p>
